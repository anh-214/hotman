    ...
    <div class="card card-body blur shadow-blur mx-4 mt-n6 overflow-hidden">
        <div class="row gx-4">
            ...
            <div class="col-auto my-auto">
                ...
                <p class="mb-0 font-weight-bold text-sm">
                    @if($admin->role == '1'){{'Admin'}} @elseif ($admin->role == '2'){{'Manager'}} @else {{'Order'}} @endif
                </p>
                </div>
            </div>
...
{{-- modal notification changepassword --}}
    <div class="modal fade" id="changePasswordModal" aria-hidden="true" aria-labelledby="exampleModalToggleLabel" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body" id="resultChangePassword">
                </div>
                <div class="modal-footer">
                    <button class="btn btn-primary goToSetting" id="closeChangePassword" data-bs-dismiss="modal" aria-label="Close">Đóng</button>
                </div>
            </div>
        </div>
    </div>
    <div class="modal fade" id="changePasswordModal1" aria-hidden="true" aria-labelledby="exampleModalToggleLabel" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalToggleLabel">Thông báo</h5>
                ...
                <div class="modal-body" id="resultChangePassword1">
                </div>
                <div class="modal-footer">
                    <button class="btn btn-primary" id="closeChangePassword1" data-bs-dismiss="modal" aria-label="Close">Đóng</button>
                </div>
            </div>
        </div>
    </div>
...
<div class="modal fade" id="notificationUpdateModal" aria-hidden="true" aria-labelledby="exampleModalToggleLabel" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalToggleLabel">Thông báo</h5>
            ...
            <div class="modal-body" id="textNotificationUpdateModal">
                Cập nhật thông tin thành công
            </div>
            <div class="modal-footer">
                <button class="btn btn-primary" id="closeNotificationUpdateModal" data-bs-dismiss="modal" aria-label="Close">Đóng</button>
            </div>
        </div>
    </div>
</div>
                ...
                if ($checkPassword == true && $checkOldPassword == true){
                    ...
                    success: function(data){
                        if (data.result == 'success'){
                            // location.reload()
                            $('#resultChangePassword').text('Đổi mật khẩu thành công')
                            $('#changePasswordModal').modal('show')
                        } else {
                            $('#resultChangePassword1').text('Đổi mật khẩu thất bại, vui lòng kiểm tra lại mật khẩu cũ')
