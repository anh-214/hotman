    ...
    <section class="min-vh-100 mb-8">
        ...
        <div class="container">
            ...
            <div class="col-lg-6 text-center mx-auto">
                <h1 class="text-white mb-2 mt-5">Chào mừng quay trở lại !</h1>
                <p class="text-lead text-white">Điền vào form bên dưới để tiến hành đăng nhập</p>
            </div>
            </div>
        </div>
        </div>
            ...
            <div class="card z-index-0">
                ...
                <form role="form" method="POST">
                    ...
                    <div class="text-center">
                        <button type="button" class="custom-btn-login btn w-100 mt-4 mb-0" id="btn-login">Đăng nhập</button>
                    </div>
                </form>
                <div class="text-center pt-4">
                    <p class="mb-4 text-sm mx-auto">
                        <a href="{{url('/user/forgotpassword')}}" class="font-weight-bolder" style="color: #F7941D">Quên mật khẩu</a>
                    </p>
                    <p class="text-sm mx-auto">
                    Không có tài khoản ?
                    <a href="{{url('user/register')}}" class="font-weight-bolder" style="color: #F7941D">Đăng ký ngay</a>
                    </p>
                </div>
                </div>
            </div>
