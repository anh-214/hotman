...
<body class="g-sidenav-show  bg-gray-100">
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
        ...
        <ul class="navbar-nav">
            <li class="nav-item">
            <a class="nav-link @if ($select == 'dashboard'): {{'active'}} @endif " href="{{url('/admin/dashboard')}}"> <!-- link  -->
                <!-- icon -->
            ...
            <a class="nav-link  " href="../pages/virtual-reality.html">
                ...
                <span class="nav-link-text ms-1">Quản lí nghành hàng</span>
            </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
            <a class="nav-link @if ($select == 'manager'): {{'active'}} @endif " href="{{url('/admin/manager')}}">
                <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link @if ($select == 'profile'): {{'active'}} @endif  " href="{{url('/admin/profile')}}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
